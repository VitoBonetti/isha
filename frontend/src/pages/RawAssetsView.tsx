...
export default function RawAssetsView() {
  ...
  const handleDownloadTemplate = () => {
    // Generate a perfect CSV template dynamically
    const csvContent = "Name,Description\nPrimary Banking API,Handles primary transaction data routing.\nInternal HR Portal,Employee management system.";
  ...
  const handleImportExcel = async () => {
    ...
    fileInput.type = 'file';
    fileInput.accept = '.csv,.xlsx,.xls'; // Added .csv support!
      ...
      <div className="pt-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 items-center justify-between bg-white dark:bg-zinc-900 p-4 rounded-xl border border-slate-200 dark:border-zinc-800 shadow-sm relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleDownloadTemplate} className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 rounded-lg hover:bg-slate-200 dark:hover:bg-zinc-700 transition-colors font-medium">
